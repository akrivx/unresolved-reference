...
Call it C with stdlib. C++ began as "C with Classes," and discussion of the language still often centers on features such as classes, inheritance, and templates. Real codebases can look quite different. Much of their C++ may live in the library types they compose rather than in language machinery written at the application layer.
...
This is not an argument against methods, invariants, templates, operator overloading, or polymorphism when the domain calls for them. The two tiers describe where ownership and lifecycle machinery live, not the complete shape of application design. Tier-2 code can use the rest of C++ without becoming a resource-owning primitive.
...
The two-tier model does not prescribe a particular feature. It offers a way to evaluate features and tools according to where they place lifecycle complexity and how reliably they keep it there.
